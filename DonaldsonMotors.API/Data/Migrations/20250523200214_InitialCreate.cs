        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    LunchStartTime = table.Column<TimeOnly>(type: "time without time zone", nullable: false),
                    LunchEndTime = table.Column<TimeOnly>(type: "time without time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkingHours", x => x.DayOfWeek);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Bookings_Vehicles_VehicleRegistrationNumber",
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "LunchEndTime", "LunchStartTime" },
                values: new object[] { 1, new TimeOnly(14, 0, 0), new TimeOnly(13, 0, 0) });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_VehicleRegistrationNumber",
                table: "Bookings",
